...
using IdentityServer4.Helpers;

using RoomMonitor.Models;
using RoomMonitor.ViewModels;
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _events.RaiseAsync(new UserLoginSuccessEvent(user.Email, user.PersonId.ToString(), user.Email, clientId: context?.ClientId));
